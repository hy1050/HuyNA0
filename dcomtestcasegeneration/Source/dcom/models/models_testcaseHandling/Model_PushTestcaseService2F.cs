...
{
    class Model_PushTestcaseService2F
    {
        public static int rowIndex;
        public static void PushTestcaseService2F(Worksheet ws, int startRowIndex, bool selectedStatus)
        {
            if (selectedStatus)
            {
        ...
        public static void TestGroupComponent(Worksheet ws, int startRowIndex)
        {
            ...
            ws.Cells[startRowIndex, TestcaseVariables.ComponentColumnIndex] = Controller_ServiceHandling.GetServiceTestGroupIndex("2F") + Controller_ServiceHandling.GetServiceTestGroupTitle("2F");
